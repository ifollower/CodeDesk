        ...
        child: _Card(
          ...
          Column(
            ...
            children: [
              ...
              const SelectionArea(child: Text(codeDeskAttribution))
                  .marginSymmetric(vertical: 4.0),
              Container(
                  ...
                  children: [
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          Text(
                            'Copyright © ${DateTime.now().toString().substring(0, 4)} CodeDesk Contributors.\n$license',
...
class _WaylandCardState extends State<WaylandCard> {
  ...
  // On a native install this is typically "codedesk.desktop"; on Flatpak it is usually
  // the exported desktop ID derived from the Flatpak app-id (e.g. "com.codedesk.CodeDesk.desktop").
  //
