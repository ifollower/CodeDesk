...
class FfiModel with ChangeNotifier {
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsCodeDeskVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsCodeDeskVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsCodeDeskVirtualDisplays);
        }
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get codeDeskVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionsCodeDeskVirtualDisplays] ?? []);
  ...
  bool get isCodeDeskIdd =>
      platformAdditions[kPlatformAdditionsIddImpl] == 'codedesk_idd';
