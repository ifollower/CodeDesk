...
///
/// Note:
/// On Linux, we use D-Bus to communicate between multiple CodeDesk processes.
...
const DBUS_NAME: &str = "com.codedesk.remote";
...
impl fmt::Display for DbusError {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "CodeDesk D-Bus error: {}", self.0)
    }
}
...
/// `dbus-send --session --print-reply --dest=com.codedesk.remote /dbus com.codedesk.remote.NewConnection string:'PEER_ID'`
